...
export const EVENTS: Event[] = [
  // ── Technical Events (ABSTRACT) ──
  {
    ...
    rules: [
      "Solo or team (max 3).",
      "Submit abstract via email before 2nd March 2026.",
      "Shortlisted papers notified via email from 3rd to 5th march 2026.",
  ...
  },
  {
    ...
    rules: [
      "Solo or team (max 3).",
      "Submit abstract via email before 2nd March 2026.",
      "Shortlisted notified via email from 3rd to 5th march 2026.",
  ...
  // ── Non-Technical Events (SUBMISSION — online) ──
  {
    ...
    rules: [
      ...
      "Last date for submission: 4th March 2026.",
    ],
    track: "C",
    timeSlot: "ONLINE",
