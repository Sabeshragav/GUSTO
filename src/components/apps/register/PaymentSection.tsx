            ...
            <div className="flex flex-col gap-1">
                ...
                {!preview ? (
                    <div
                        ...
                        className={`flex flex-col items-center justify-center p-6 rounded border-2 border-dashed cursor-pointer transition-colors ${isDragOver
                ...
                <AnimatePresence>
                    {(fileError || errors.screenshot) && (
                        ...
                        >
                            <AlertCircle size={11} />
                            <span>
                                {fileError || (errors.screenshot?.message as string)}
                            </span>
                        </motion.div>
                    )}
                </AnimatePresence>
