...
const dockItems: DockItem[] = [
  ...
  { id: 'settings', name: 'Settings', iconName: 'settings', appId: 'systemPreferences' },
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Divider */}
        <div className={`w-px self-center ${isMobile ? 'h-6 mx-1' : 'h-10 mx-2'}`} style={{ backgroundColor: 'var(--border-color)' }} />

        {/* Trash */}
        <DockIcon
           item={{ id: 'trash', name: 'Trash', iconName: 'trash', appId: 'trash' }}
           mouseX={mouseX}
      ...
      >
        <div className="w-3/5 h-3/5 text-[var(--ph-orange)]">
           <ThemedIcon 
             ...
             style={isTrash && hasItems ? { color: 'var(--ph-orange)' } : isTrash ? { color: 'var(--text-secondary)' } : undefined}
           />
        </div>
